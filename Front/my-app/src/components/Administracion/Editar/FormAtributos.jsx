...
function FormAtributos(){
    ...
    let style = {
        ...
        return(data &&
            <div className="atributosPropiedad" id="atributosEditarId">
                ...
                <div className="atributo" >
                    <div className="nombreAtributoPropiedad" key={index}> 
                        ...
                        <input placeholder="" name="atributoNombreEditar" className="inputNombreAtributoPropiedad" value={item.atributoNombre} onChange={(e)=>onchange(index,e)}></input>
                    </div>

                    <div className="iconoAtributoPropiedad" key={index}>
                        <label className="labelAtributoPropiedad">Icono</label>
                        <RSelect options={infoAtributo} placeholder={"Seleccione un icono"} styles={style} name="atributoIconoEditar">  
